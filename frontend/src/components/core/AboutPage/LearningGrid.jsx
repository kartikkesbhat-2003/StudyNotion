...
export const LearningGrid = () => {
  return (
    <div className='max-w-maxContent w-11/12 my-20 grid mx-auto grid-cols-1 lg:grid-cols-4 lg:w-fit'>
        {
                ...
                >
                    {
                        ...
                        (
                            <div className={`lg:w-[90%] flex flex-col gap-3 `}>
                                <div className='text-4xl font-semibold '>
                                    {card.heading}
                                    <HighlightText gradient="blue" text={card.highlightText} />
                                </div>
                                <p className='text-md font-medium text-richblack-300 '>{card.description}</p>
                        ...
                        (<div className='flex flex-col gap-8 p-5'>
                            <h1 className='text-richblack-5 font-semibold text-lg w-[80%]'>
                                {card.heading}
                            </h1>
